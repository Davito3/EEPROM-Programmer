...
sharedValue ds 1
SoftTimer0 ds 2             ; file1 Task
SoftTimer1 ds 2             ; file2 Task
SoftTimer2 ds 2             ; file3 Task
...
#include NAME_file1_handler.inc
#include NAME_file2_handler.inc
#include NAME_file3_handler.inc
